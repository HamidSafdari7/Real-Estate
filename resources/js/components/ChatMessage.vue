      ...
      <div class="card">
           ...
           <li class="sender clearfix" v-if="allmessages.user.id === msg.sender_id" >
              ...
              <div class="chat-body2 clearfix">
                <div class="header clearfix">
                  ...
                  <strong class="primary-font" style="color: #0169da;">{{ msg.user.name }}</strong>
        ...
        <!-- my part  -->
            <li class="buyer clearfix" v-else>
              ...
              <div class="chat-body clearfix" style="background-color:#CCCCCC;">
                <div class="header clearfix">
                  <small class="left text-muted"
                    >{{ dateTime(msg.created_at) }}</small><br>
                  <strong class="right primary-font">{{ msg.user.name }} </strong>   
                   
                </div>
                <p style="color:black;">{{ msg.msg }}</p>
              </div>
            </li>
...
export default {
    ...
    sendMsg(){
      ...
      axios.post('/send-message',{ reciever_id:this.selectedUser, msg:this.msg })
      .then((res) =>{
        this.msg="";
        this.userMessage(this.selectedUser);
