            ...
            <div class="header-top">
                <div class="top-inner clearfix">
                    ...
                    <div class="right-column pull-right">
                        ...
                        @auth
                        <div class="sign-box">
                            <a href="{{ route('dashboard') }}"><i class="fas fa-id-card-alt"></i>Dashboard</a>
    ...
    <nav class="main-menu navbar-expand-md navbar-light">
        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
            <ul class="navigation clearfix">
                ...
                <li><a href="#anchorAboutUs"><span>About Us</span></a> </li>
                ...
                <li><a href="#anchorAgents"><span>Agents</span></a> </li>
                 
                <li><a href="#anchorBlogs"><span>Blog</span></a> </li>
                  
                <li><a href="{{ route('admin.login') }}" class="btn btn-inverse-warning"><i class="fa fa-sign-in" aria-hidden="true"><span> Admin</span></i></a></li>

                <li><a href="{{ route('agent.login') }}" class="btn btn-inverse-warning"><i class="fa fa-sign-in" aria-hidden="true"><span> Agents</span></i></a></li>   
            </ul>
        </div>
    </nav>
</div>
