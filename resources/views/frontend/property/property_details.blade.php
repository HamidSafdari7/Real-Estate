                                ...
                                <div class="author-box">
                                    ...
                                    <div class="inner">
                                        ...
                                        <div id="app">
                                            ...
                                            <send-message :recieverid="{{ $property->agent_id }}" recievername="{{ $property->user->name }}">
                                                
                                            </send-message>

                                        </div>
                                        @else
                                        <span class="text-danger">For Live Chat Login First !!</span>
                                        @endauth
