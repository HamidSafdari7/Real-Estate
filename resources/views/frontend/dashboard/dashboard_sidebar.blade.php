<div class="widget-content">
    ...
    <li><a href="{{ route('user.schedule.request') }}"><i class="fa fa-list-alt" aria-hidden="true"></i> Schedule Requests<span class="badge badge-info"></span></a></li>
    <li><a href="{{ route('user.compare') }}"><i class="fa fa-list-alt" aria-hidden="true"></i></i> Compare List </a></li>
