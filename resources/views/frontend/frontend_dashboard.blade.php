    ...
    function compare() {
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                var rows = "";
                var property_count = response.length;
...
for (var i = 0; i < property_count; i++) {
    var property = response[i].property;
    rows += `
        <td>
            <figure class="image-box"><img src="/${property.property_thumbnail}" alt=""></figure>
            <div class="title">${property.property_name}</div>
            <div class="price">$${property.lowest_price}</div>
        </td>
    `;
}
...
// Create rows for property details
rows += `
    <tr>
        <td>
            <p>City</p>
...
for (var i = 0; i < property_count; i++) {
    ...
    rows += `
        <td>
            <a type="submit" class="text-body" id="${response[i].id}" onclick="compareRemove(this.id)"><i class="fa fa-trash"></i></a>
        </td>
    `;
}
