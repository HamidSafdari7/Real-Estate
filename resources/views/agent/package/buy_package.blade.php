                    ...
                    <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h5 class="text-success text-center mb-4">Up To 3 Propertys</h5>
                          <table class="mx-auto">
                            <tr>
                              <td><i data-feather="check" class="icon-md text-primary me-2"></i></td>
                              <td><p>Up To 3 Propertys</p></td>
                            </tr>
                    ...
                    <div class="col-md-4 stretch-card">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <p class="text-muted text-center mb-4 fw-light">Unlimited Months</p>
                          <h5 class="text-primary text-center mb-4">Up To 10 Propertys</h5>
                          <table class="mx-auto">
                            <tr>
                              <td><i data-feather="check" class="icon-md text-primary me-2"></i></td>
                              <td><p>Up To 10 Propertys</p></td>
                            </tr>
