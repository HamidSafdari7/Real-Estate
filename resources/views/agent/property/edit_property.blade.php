                            ...
                            <form method="POST" action="{{ route('agent.update.property') }}" id="myForm" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                                                ...
                                                <option value="{{ $am->amenities_name }}" {{ (in_array($am->amenities_name,$property_ami)) ? 'selected' : '' }}>{{ $am->amenities_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div><!-- Col -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="long_descp" id="tinymceExample" rows="10">{!! $property->long_descp !!}
                                            </textarea>
                                        </div>
                                    </div><!-- Col -->
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-check-inline">
                                        <input name="featured" value="1" type="checkbox" class="form-check-input" id="checkInline1" {{ $property->featured == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input name="hot" value="1" type="checkbox" class="form-check-input" id="checkInline" {{ $property->hot == '1' ? 'checked' : '' }}>
          ...
          <!-- middle wrapper start -->
            <div class="col-md-12 col-xl-12 middle-wrapper">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Edit Main Thumnial Image</h6>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                <td class="py-1">
                                                    <img src="{{ asset($img->photo_name) }}" alt="image" style="width:53px; height:53px;">
                                                </td>
    ...
    function mainThumUrl(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function(e){
                ...
                $('#mainThum').attr('src',e.target.result).width(100).height(100);
            };
