          ...
          <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
              ...
              <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('update.testimonials') }}"
                ...
                @csrf
                  ...
                  <div class="mb-3">
                    ...
                    <img id="showImage" class="wd-80 rounded-circle" src="{{ asset($testimonial->image) }}" alt="profile" style="height:80px;">
                  </div>
